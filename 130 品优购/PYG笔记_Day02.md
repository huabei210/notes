...
1. .今日目标
2. .angularJS简介 (了解)
3. .angularJS四大特征 (学完当天课程后理解)
4. .angularJS入门小demo(1-3) (重点)
5. .angularJS入门小demo4 (重点)
6. .angularJS入门小demo(5-6) (重点)
7. .angularJS入门小demo(7) (重点)
8. .angularJS入门小demo(8) (重点)
9. .品牌列表-需求分析    (下面的视频全是练习,需要完成)
10. .品牌列表-1
11. .品牌列表-2
12. .品牌分页-需求分析
13. .品牌分页-后端-1
